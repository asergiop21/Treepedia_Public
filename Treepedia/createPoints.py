...
if __name__ == "__main__":
    ...
    inshp = os.path.join(root,'elbosque_elmonte_ista_maipo_4326.shp')
    #inshp = os.path.join(root,'providencia.shp')
    outshp = os.path.join(root,'elbosque_elmonte_ista_maipo_4326_20m.shp')
    #outshp = os.path.join(root,'providencia20m.shp')
